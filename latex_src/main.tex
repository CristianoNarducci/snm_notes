...
\include{chaps/01_basic_concepts}
\include{chaps/02_introduction_to_cryptography}
\include{chaps/03_cryptography_algorithms}
\include{chaps/04_internet}
\include{chaps/05_ipv6}
\include{chaps/06_nat}
\include{chaps/07_attacks_vulnerabilities}
\include{chaps/08_whos_who_identity_issue}
\include{chaps/09_firewalls}
\include{chaps/10_wifi}
\include{chaps/11_authentication_methods}
\include{chaps/12_attacks}
\include{chaps/13_vpn_vlans}
\include{chaps/14_vulnerability_assessment}
